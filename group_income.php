...
<div class="container">
		...
		<div id="header">
			...
			<h2>Comission Details</h2> - <h3>Group Income</h3> <div id="date"><?php get_date(); ?></div>
		</div>
		<div id="header" style="border:0.5px solid lightgray;padding-top: 0px;padding-bottom:0px;">
			<i class="fa fa-home"></i><p>Home / </p> <p>Comission Details /</p> <p>Daily Income /</p> <p>Group Income</p>
		</div>
		<div id="body">
<table>
  <tr>
